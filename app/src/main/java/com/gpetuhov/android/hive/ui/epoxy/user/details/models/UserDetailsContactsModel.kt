...
abstract class UserDetailsContactsModel : EpoxyModelWithHolder<UserDetailsContactsHolder>() {
    ...
    @EpoxyAttribute var websiteVisible = true
    @EpoxyAttribute var websiteSeparatorVisible = true
    ...
    override fun bind(holder: UserDetailsContactsHolder) {
        ...
        holder.websiteWrapper.setVisible(websiteVisible)
        holder.websiteSeparator.setVisible(websiteSeparatorVisible)
...
class UserDetailsContactsHolder : KotlinHolder() {
    ...
    val websiteWrapper by bind<View>(R.id.user_details_website_wrapper)
    val website by bind<TextView>(R.id.user_details_website)
    val websiteSeparator by bind<View>(R.id.user_details_website_separator)
}