...
interface Repo {
    ...
    fun currentUserInterests(): String
    fun currentUserStatus(): String
    ...
    fun saveReview(reviewUid: String, offerUid: String, text: String, rating: Float, ratingChanged: Boolean, onSuccess: () -> Unit, onError: () -> Unit)
    fun clearReviews()
