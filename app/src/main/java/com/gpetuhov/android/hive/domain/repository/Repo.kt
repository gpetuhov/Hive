...
interface Repo {
    ...
    fun addFavorite(userUid: String, offerUid: String, onSuccess: () -> Unit, onError: () -> Unit)
    fun removeFavorite(userUid: String, offerUid: String, onSuccess: () -> Unit, onError: () -> Unit)
}
